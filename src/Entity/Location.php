 ...
 * @ORM\Entity(repositoryClass="Redeemar\Entity\LocationRepository")
 */
class Location
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Redeemar\Entity\Company")
     * @ORM\JoinColumns({
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Redeemar\Entity\Campaign", mappedBy="locations")
     */
    private $campaigns;  
