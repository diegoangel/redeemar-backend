...
namespace RedeemarUserBundle\Datatables;
 ...
 *
 * @package RedeemarUserBundle\Datatables
 */
class OfferDatatable extends AbstractDatatableView
{
    ...
    public function buildDatatable($locale = null)
    {
        $this->topActions->set(array(
            ...
            'actions' => array(
                array(
                    'route' => $this->router->generate('owner_redeemar_offer_new'),
        ...
        $this->ajax->set(array(
            'url' => $this->router->generate('owner_redeemar_offer_results'),
            'type' => 'GET'
        ));
        ...
        $this->columnBuilder
            ...
            ->add(null, 'action', array(
                ...
                'actions' => array(
                    array(
                        'route' => 'owner_redeemar_offer_show',
                    ...
                    array(
                        'route' => 'owner_redeemar_offer_edit',
                        'route_parameters' => array(
                            'id' => 'id'
                        ),
    ...
    {
        return 'redeemar_offer_datatable';
    }
}
