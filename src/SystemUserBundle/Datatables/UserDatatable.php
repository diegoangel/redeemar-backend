...
class UserDatatable extends AbstractDatatableView
{
    ...
    public function buildDatatable($locale = null)
    {
        $this->topActions->set(array(
            ...
            'actions' => array(
                array(
                    'route' => $this->router->generate('system_user_new'),
        ...
        $this->ajax->set(array(
            'url' => $this->router->generate('system_user_results'),
            'type' => 'GET'
        ));
