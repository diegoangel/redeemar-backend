...
/**
 * Class ValidatorUserLogDatatable
 *
 * @package SystemUserBundle\Datatables
 */
class ValidatorUserLogDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable($locale = null)
    {
        ...
        $this->columnBuilder
            ...
            ->add('offerId', 'column', array(
                'title' => 'OfferId',
            ))
            ->add('userId', 'column', array(
                'title' => 'UserId',
            ))
            ->add('amount', 'column', array(
                'title' => 'Amount',
            ))
            ->add('locationId', 'column', array(
                'title' => 'LocationId',
            ))
    ...
    {
        return 'Redeemar\Entity\ValidatorUserLog';
    }
